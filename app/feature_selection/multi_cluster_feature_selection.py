...
def mcfs(X, n_selected_features, **kwargs):
    ...
    Reference
    ---------
    (https://www.researchgate.net/publication/221653532_Unsupervised_feature_selection_for_Multi-Cluster_data)
    ...
    if 'W' not in kwargs:
        W = construct_mcfs_W(X)
    else:
        W = kwargs['W']
    if kwargs['metric'] == 'gower':
